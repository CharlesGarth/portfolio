    ...
    return (
        <Card id="contact" title="Contact" centered>
            ...
            >
                ...
                <div className="p-1 w-1/2 rounded-lg bg-gradient-to-r to-red-500 from-blue-500">
                    <textarea
                        className={`p-3 w-full rounded ${message ? 'text-black' : 'text-gray-400'}`}
                        form="contact"
                ...
                />
                <div className='h-10'>
                    {showToast && <span className="inline-block py-2">
                        Thanks! I can&apos;t wait to read it. {' '}
                        <Image src="/assets/icons/tick.svg" width={30} height={20} alt="a tick mark" />
                    </span>}
                </div>
            </form>
        </Card>
