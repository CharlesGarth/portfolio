...
export const Card: React.FC<ICardProps> = ({
    ...
    <div className="container my-2 sm:my-5 md:my-10 lg:my-20 mx-auto px-2 sm:px-4 md:px-12 lg:px-gutters">
        <h2
            ...
            className={`${
                centered && 'mx-auto'
            } text-xl md:text-2xl lg:text-5xl w-fit h-14 font-body font-light tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-blue-500 overflow-visible scroll-mt-32`}
        >
            {title}
        </h2>
