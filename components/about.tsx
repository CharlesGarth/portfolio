    ...
    <Card id="about" title="About Me" onEnter={() => setSection('about')}>
        <div className="my-1">
            <div className="flex flex-col-reverse md:flex-row md:justify-center lg:justify-start gap-2">
                <div className="prose prose-slate prose-a:text-blue-500 hover:prose-a:text-blue-600 md:prose-p:text-xs lg:prose-p:text-base md:prose-headings:text-xs lg:prose-headings:text-base dark:prose-p:text-white dark:prose-headings:text-white dark:prose-strong:text-white">
                    <AboutMarkdown />
                </div>
